...
export default function VyloBrief() {
  return (
    <section
      id="brief"
      ...
      <div className="grid gap-12 lg:grid-cols-[minmax(0,0.85fr)_minmax(0,1.15fr)] lg:gap-20 xl:gap-28">
        <Reveal>
          ...
          <h2 className="mt-5 text-[clamp(2.5rem,5.5vw,4.75rem)] font-black leading-[1.02] tracking-tight">
            ...
            <span className="text-[#a3a0ad]"> Polish of a modern social app.</span>
          </h2>
        </Reveal>
        ...
        <div className="flex flex-col justify-end gap-8 lg:pt-16">
          ...
          <p className="max-w-[34rem] text-base leading-relaxed text-neutral-500 sm:text-lg">
            Vylo was designed as a full consumer product: iOS, matchmaking,
            messaging, location-aware discovery, safety systems, and a real-time
            backend. Immediate without anonymous. Social without becoming a
            dating app.
          </p>
        </div>
      </div>
